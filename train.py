...
def set_args():
    ...
    parser.add_argument('--val_num', type=int, default=10, help='验证集大小')
...
def train(model, logger, train_dataset, validate_dataset, args):
    train_dataloader = DataLoader(
        train_dataset, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers, collate_fn=collate_fn,
        drop_last=True
    )
    print('data~~~~~~~~',len(train_dataloader))
